...
extern c_Game_app* bb_MathsGame_Game;
int bbMain();
...
c_Game_app* c_Game_app::m_new(){
	...
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<10>");
	c_App::m_new();
	return this;
}
int c_Game_app::p_OnCreate(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<16>");
	bb_app_SetUpdateRate(60);
	DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<17>");
	gc_assign(m_startscreen,bb_graphics_LoadImage(String(L"startscreen.png",15),1,c_Image::m_DefaultFlags));
	return 0;
}
...
int c_Game_app::p_OnRender(){
	...
	c_Game_app *self=this;
	DBG_LOCAL(self,"Self")
	DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<22>");
	String t_1=m_GameState;
	DBG_LOCAL(t_1,"1")
	DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<23>");
	if(t_1==String(L"START",5)){
		DBG_BLOCK();
		DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<24>");
		bb_graphics_DrawImage(m_startscreen,FLOAT(0.0),FLOAT(0.0),0);
	}
	return 0;
}
void c_Game_app::mark(){
	c_App::mark();
	gc_mark_q(m_startscreen);
}
String c_Game_app::debug(){
	String t="(Game_app)\n";
	t=c_App::debug()+t;
	t+=dbg_decl("startscreen",&m_startscreen);
...
BBGame* bb_app__game;
c_Game_app* bb_MathsGame_Game;
int bbMain(){
	DBG_ENTER("Main")
	DBG_INFO("C:/Users/User/Documents/Chloe/GitHub/Coursework/MathsGame.monkey<6>");
	gc_assign(bb_MathsGame_Game,(new c_Game_app)->m_new());
	return 0;
}
...
int bbInit(){
	...
	bb_MathsGame_Game=0;
	DBG_GLOBAL("Game",&bb_MathsGame_Game);
	...
	c_Game_app::m_GameState=String(L"START",5);
